...
@Component({
  ...
  imports: [MyAccountComponent,CommonModule,FormsModule],
...
export class ProfileComponent {
    ...
    //   this.updateUserProfile(updatedUser).subscribe(
    //     (response) => {
    //       console.log('Profile changes saved to API:', response);
    //       this.isEditMode = false;  
    //     },
    //     (error) => {
    //       console.error('Error saving profile changes to API:', error);
    //     }
    //   );
    // }
    ...
    //   if (signupUser) {
    //     const parsedUser = JSON.parse(signupUser);
    //     this.userName = parsedUser.User_Name;
    //     this.userEmail = parsedUser.Email_Id;
    //     this.mobileNo = parsedUser.Mobile_No;
    //   }
    // }
   
    // updateUserProfile(user: any): Observable<any> {
    //   const apiUrl = 'https://businessguruerp.com/adminsavra/business_guru_admin/User_Account_Operations.php';
  ...
  //     // Optional: Only trigger if length is significant
  ...
  // } else {
  //   // Optional: Clear city/state if input too short
  //   this.Address_4 = '';
  //   this.Address_5 = '';
  ...
  //             this.Address_5 = '';
  //             this.isAddressFieldsEnabled = false;
  //             alert("Could not find a valid city name for the given district.");
  //           }
  //         } else {
  //           this.Address_4 = '';
  //           this.Address_5 = '';
  ...
  //       alert(message);
  //       this.hasShownInvalidDistrictAlert = true; // ✅ Prevent repeat alert
  //     }
  //   }
